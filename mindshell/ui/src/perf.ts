...
export const PERF_MODES: PerfModeInfo[] = [
  { mode: 'balanced', label: 'Balanced', icon: 'gauge', blurb: 'Full speed under load, low power when idle.', detail: 'schedutil governor, EPP balance, boost on, the kernel EEVDF scheduler, transparent huge pages, proactive compaction.' },
